...
static void armv7m_realize(DeviceState *dev, Error **errp)
{
    ...
    if (object_property_find(OBJECT(s->cpu), "data-endianness")) {
        if (!object_property_set_uint(OBJECT(s->cpu), "data-endianness",
                                      s->data_endianness, errp)) {
            return;
        }
    }
...
static Property armv7m_properties[] = {
    ...
    DEFINE_PROP_UINT32("data-endianness", ARMv7MState, data_endianness, 0),
